"""add weight_lbs to vehicle model

Revision ID: 59d713355d76
Revises: 0b8989b2f4e0
Create Date: 2025-12-31 14:09:51.758507
...
revision: str = '59d713355d76'
down_revision: Union[str, Sequence[str], None] = '0b8989b2f4e0'
...
def upgrade() -> None:
    ...
    op.add_column('vehicles', sa.Column('weight_lbs', sa.Integer(), nullable=True))
